...
public class GetRecipesResults {
    ...
    public GetRecipesResults(Context context, ResultAdapter adapter) {
    ...
    public void execute(String query) {
        Call<List<RecipeResult>> call = routes.autocompleteRecipes(query, 10);
